               ...
               <div className='grid grid-flow-row xl:grid-cols-2 gap-4 xl:gap-16 items-center'>
                  ...
                  <div className='mt-3 text-sm leading-8 text-text'>
                     <p>
                        ...
                        inspirational information! I'm thrilled to introduce you
                        to our one-of-a-kind application that's designed to
                        uplift your spirit and fill your heart with the joy .
                     </p>
                     <p>
                        This Blog is not just an app; it's a platform that
                        brings the power of gospel stories to your fingertips.
                        With a vast library of handpicked, faith-based stories,
                        we aim to inspire, entertain, and strengthen your
                        connection with your beliefs.
                     </p>
                  </div>
