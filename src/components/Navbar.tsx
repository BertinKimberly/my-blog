            ...
            >
               ...
               {status === "authenticated" ? (
                  <>
                     <div
                        ref={popupRef}
                        className={`absolute z-30 right-0 top-[6.5rem]  p-6 shadow-lg border border-[#5B56F421] border-t-0 rounded-md flex-col gap-4 text-left min-w-[180px] bg-white dark:bg-nav ${
